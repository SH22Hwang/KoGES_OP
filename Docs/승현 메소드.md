...
| binary(0 또는 1) | cath0 (계층 없는 범주형 변수) | cath1 (계층 있는 범주형 변수) | cnt (연속형 변수)       | dependent (종속변수) |
| -------------- | -------------------- | -------------------- | ------------------ | ---------------- |
| AS1_SEX        | AS1_JOBB             | AS1_EDUA             | AS1_AGE            | AS1_DT           |
| AS1_HT         | AS1_FMHTREL_N        | AS1_DRINK            | AS1_TOTALC         | AS1_MT           |
| AS1_DM         | AS1_FMHTREL_P        | AS1_SMOKEA           | AS1_SLPAMTM        |                  |
